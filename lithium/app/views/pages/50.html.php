...
<div class="row">
	...
	<div class="span9">
		...
		We donate 50% of our profits to nonprofit organizations locally and globally. As stories are submitted to BYC, the locations are tagged by the contributors so we can track which geographical area the donation will serve. As BYC grows, we will feature each organization as it relates to a story's origin, so you can follow where the 50% profit sharing goes. For example, if a contributor's story is about a restaurant is in the Lower East Side of Manhattan, 50% of the profit each time that story is sold will go right back to a Lower East Side charity. Similarly, if a story is about a park in the Latin Quarter in Paris, the 50% will go to a non-profit organization right in the Latin Quarter. As long as BYC's content is geographically diverse, the local and global implications of this 50% profit sharing is far-reaching.
		<p>
		<p>
