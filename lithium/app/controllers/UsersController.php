...
class UsersController extends \lithium\action\Controller 
{
    ...
    public function fetchSelf()
    {
    	...
    	$user = Users::first(array('conditions' => array('slug' => $userSlug), 'fields' => array('title','text','tags','city','hood','country','url','email','public','photos','captions')));
    	if($user)
    	{
    ...
    public function getBySlug()
    {
    	...
    	//echo($userSlug);
    	$story = Users::first(array('conditions' => array('slug' => $userSlug, 'public' => 1), 'fields' => array('title','text','tags','city','hood','country','url','updated','photos','captions')));
    	if($story)
    	{
